  ...
  <div>
    ...
    <v-card v-if="invoice != null">
              ...
              <template v-slot:default>
                <tbody>
                  <tr>
                    ...
                    <td class="text-14">{{ invoice.repair.car.CarTitle }} {{ invoice.repair.car.CarNumber }} {{ invoice.repair.car.province.name_th }}</td>
                  </tr>
                  <tr>
          ...
          <v-col cols="12" md="3" class="mt-3">
            ...
            <div class="d-flex align-center justify-space-between text-14 font-weight-semibold mb-4">
              <div class="d-flex align-center justify-space-between">
                ...
                <v-switch v-show="invoice.InvoiceStatusID == 1" v-model="invoice.isVat" @change="switchVat" color="orange" hide-details></v-switch>
              </div>
      ...
      <v-card-actions>
        ...
        <v-btn v-show="invoice.InvoiceStatusID == 1" color="secondary" variant="flat" class="mb-3 mr-2" @click="changeInvoiceStatus(2)" :disabled="isEdit">
        ...
        <v-btn v-show="invoice.InvoiceStatusID == 1" @click="saveSubmitEdit" color="primary" variant="flat" class="mb-3 mr-3"> บันทึกข้อมูล </v-btn>
      </v-card-actions>
    </v-card>
  </div>
</template>
