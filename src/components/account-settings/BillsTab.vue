    ...
    <v-col cols="12" md="9">
      <v-card elevation="10">
        <v-card-item>
          ...
          <div class="mt-4">
            <div
              class="text-subtitle-1 text-textPrimary opacity-80 text-10 mb-3"
            >
              If you updated your payment method, it will only be dislpayed here
              after your next billing cycle.
            </div>
            <v-btn class="text-error" variant="outlined" flat
