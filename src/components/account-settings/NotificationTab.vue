...
// สมมติว่า icons มาจาก vue-tabler-icons เหมือนตัวอย่างก่อนหน้า
import { ClockIcon, DownloadIcon, PlayerPauseIcon } from "vue-tabler-icons";

export default {
  components: {
    // ลงทะเบียน icon components ที่ใช้ใน template
    ClockIcon,
    DownloadIcon,
    PlayerPauseIcon,
  },
  data() {
    return {
      // ข้อมูลที่ import มา จะต้อง return จาก data() เพื่อให้ template เรียกใช้ได้
      notificationTb: notificationTb,
      // state ที่เคยสร้างด้วย ref()
      switchoff3: false,
    };
  },
};
        ...
        <v-card-item>
          ...
          <div class="mt-6">
            ...
            <v-text-field
              ...
              hide-details
            ></v-text-field>
            <span class="text-subtitle-1 text-textPrimary opacity-80"
          ...
          >
            ...
            <div class="pl-4">
              ...
              <h5 class="text-subtitle-1 text-textPrimary opacity-80">
                {{ list.subtitle }}
              </h5>
            </div>
        ...
        <v-card-item>
          ...
          <div>
            <div class="d-flex align-center mt-7">
              ...
              <div class="pl-4">
                <h5 class="text-subtitle-1 text-textPrimary opacity-80 mb-1">
                  Time zone
                </h5>
