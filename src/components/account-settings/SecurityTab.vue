        ...
        <v-card elevation="10">
          <v-card-item>
            ...
            <div class="d-sm-flex justify-space-between mt-4 mb-8">
              <div
                class="text-subtitle-1 text-textPrimary opacity-80 text-13 pr-5"
              >
      ...
      <v-col cols="12" md="4">
        <v-card elevation="10">
          <v-card-item>
            ...
            <div
              class="text-subtitle-1 mt-3 text-textPrimary opacity-80 text-10"
            >
              Lorem ipsum dolor sit amet consectetur adipisicing elit Rem.
            </div>
            <v-btn color="primary" class="mt-4" flat
              >Sign out from all devices</v-btn
            >
            ...
            <v-btn class="bg-lightsecondary text-primary mt-5" block flat
              >Need Help?</v-btn
            >
          </v-card-item>
        </v-card>
