        ...
        <div>
          <div class="d-flex justify-space-between align-center pt-1">
            <div class="d-md-flex align-center">
              <h3 class="text-h6 cursor-pointer hover-primary lh-normal">
                John Doe
              </h3>
          ...
          <p class="textSecondary text-15">
            assign a new task
            <span class="text-primary cursor-pointer">Design weblayout</span>
          </p>
            ...
            <v-col cols="12" lg="5">
              <div class="border rounded-md px-7 py-5">
                <div class="d-flex ga-3 align-center">
                  <img
                    src="@/assets/images/svgs/icon-zip.svg"
                    height="40"
                    alt="user"
                  />
                  <div>
